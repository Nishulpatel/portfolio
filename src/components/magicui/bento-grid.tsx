...
const BentoGrid = ({ children, className, ...props }: BentoGridProps) => {
  return (
    <div
      className={cn(
        "grid w-full auto-rows-[22rem] grid-cols-1 md:grid-cols-2 gap-4", // Changed to responsive grid
        className,
      )}
      {...props}
    >
...
const BentoCard = ({
  ...
  <div
    className={cn(
      "group relative flex flex-col justify-between overflow-hidden rounded-xl", // Removed col-span-3
      // light styles
